...
/** 고객지원 연락처 (출시 전 실제 값으로 교체) */
export const SUPPORT_EMAIL = "support@example.com";

/**
 * 검색 노출용 키워드. (중대재해처벌법·위험성평가 관련)
 * ★ 보증 표현 금지 — '대응을 돕는' 범위로만 기술한다.
 */
...
/**
 * ⚠️ 사업자 정보 (전자상거래법 표시 의무). 출시 전 실제 값으로 반드시 교체한다.
 * 통신판매업 신고·결제(PG) 심사에 필요하다.
 */
...
/**
 * ★ 강한 면책 — 법무(약관/개인정보/환불) 및 모든 공개 페이지 하단에 노출.
 * 본 서비스는 법률·안전 자문이 아니며, 적법성·적합성을 보증하지 않는다.
 * (변호사 검토 필수 — 출시 전 LEGAL_REVIEW 플래그 확인)
 */
export const LEGAL_DISCLAIMER =
  "본 서비스는 법률·안전 자문이 아니며, 위험성평가·서류의 적법성·적합성을 보증하지 않습니다. " +
  "중대재해 예방 및 법적 의무 이행의 책임은 사업주·경영책임자에게 있습니다. " +
  "서비스는 위험성평가의 작성·기록·관리를 돕는 보조 도구일 뿐이며, 정확한 적용은 산업안전 전문가의 검수가 필요합니다.";
